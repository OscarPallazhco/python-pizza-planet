...
class OrderController(BaseController):
    ...
    def calculate_order_price(size_price: float, ingredients: list, beverages: list):
        ingredients_total = sum(ingredient.price for ingredient in ingredients)
        beverages_total = sum(beverage.price for beverage in beverages)
        price = size_price + ingredients_total + beverages_total
